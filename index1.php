...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    ...
    animation: mover 1s infinite alternate;">
          <img src="https://www.pngkit.com/png/full/251-2511622_ambulance-drawing-side-view-ambulance-cartoon.png" alt="" style="width: 38%;padding-left: 30px;margin-top: 150px;margin-left: 0px;margin-bottom:15px">
      </div>
